...
-- depends_on: {{ ref('airbyte_projects_custom_fields') }}
{{ unnest_cte(ref('airbyte_projects_custom_fields'), 'custom_fields', 'enum_options') }}
select
...
from {{ ref('airbyte_projects_custom_fields') }} as table_alias
